...
import { HomeBarsNavigator } from './homeBars.navigator';
...
const ROOT_ROUTES: string[] = ['HomeBar', 'Layouts', 'Components', 'Themes'];
...
const HomeTabsNavigator = (): React.ReactElement => (
  <BottomTab.Navigator
    ...
    <BottomTab.Screen name='HomeBar' component={HomeBarsNavigator} />
